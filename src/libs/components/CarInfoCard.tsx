...
const CarInfoCard = ({ car }: { car: Car }) => {
  return (
    <div className="relative flex flex-col items-center justify-center w-full max-w-4xl mx-auto">
            ...
            <h1 className="relative z-10 font-bold text-center text-7xl">Sesongen {car.season}</h1>
            ...
            <div className="flex-1 text-center">
                <h3 className="mb-2 text-2xl font-semibold">Fokus</h3>
            ...
            <div className="flex-1 text-center">
                <h3 className="mb-2 text-2xl font-semibold">Vekt</h3>
