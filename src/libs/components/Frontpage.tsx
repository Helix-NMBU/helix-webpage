...
export default function Frontpage() {
    return (
<div className="py-12 mt-0 mb-28 bg-white">
    ...
    <div className="flex flex-col justify-center mb-8 space-y-5 md:flex-row md:space-y-0 md:space-x-6 lg:space-x-10 mt-7">
        <div className="relative md:w-5/12">
            ...
            <div className="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                <Link to="/about" className="w-full inline-block text-center px-6 py-3 text-xs bg-white opacity-95 text-chart-3 ground transition duration-300 ease-in-out transform rounded-full lg:text-md focus:outline-none hover:scale-110 hover:bg-gray-100 font-medium">Our story</Link>
            </div>
        </div>
